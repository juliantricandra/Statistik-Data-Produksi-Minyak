...
with st.container() :
    ...
    df_barchart = alt.Chart(df_b_sorted).mark_bar().encode(x=alt.X('produksi', axis=alt.Axis(title='Jumlah Produksi'),
    y=alt.Y('kode_negara', axis=alt.Axis(title='Negara')))tooltip=['produksi','tahun','region','sub_region','alpha3_negara'],)
